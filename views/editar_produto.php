            ...
            <form action="" method="POST" enctype="multipart/form-data" id="productForm">
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <input type="text" id="nome" name="nome" value="<?php echo htmlspecialchars($produto['nome']); ?>" required placeholder="Digite o nome do produto">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="price-input">
                            <input type="number" id="preco" name="preco" step="0.01" min="0" value="<?php echo $produto['preco']; ?>" required placeholder="0,00">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="file-input-wrapper">
                            ...
                            <div class="file-input-display">
                                ...
                                <span>Clique para alterar a imagem<br>ou arraste e solte aqui</span>
                            </div>
                        </div>
                        ...
                        <?php if (!empty($produto['imagem'])): ?>
                            <div class="current-image">
                                ...
                                <img src="../public/images/<?php echo $produto['imagem']; ?>" alt="<?php echo htmlspecialchars($produto['nome']); ?>">
                            </div>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="form-group full-width">
                        ...
                        <textarea id="descricao" name="descricao" placeholder="Descreva detalhadamente o produto..."><?php echo htmlspecialchars($produto['descricao']); ?></textarea>
                    </div>
                </div>
            ...
            if (file) {
                ...
                reader.onload = function(e) {
                    display.innerHTML = `
                        ...
                        <span style="font-size: 0.85rem;">Nova imagem: ${file.name}</span>
                    `;
                };
